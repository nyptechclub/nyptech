          ...
          <div className="flex flex-col justify-center space-y-4">
            <div className="space-y-2">
              ...
              <BoxReveal boxColor={"#5046e6"} duration={0.5}>
                <h2 className="mt-[.5rem] text-[1rem]">
                  Our incubator program empowers entrepreneurs to turn innovative ideas into successful businesses
                  through mentorship, resources, and a vibrant startup ecosystem.
                </h2>
              </BoxReveal>
            </div>
            ...
            <div className="flex items-center space-x-4 text-sm">
              <div className="flex items-center space-x-1">
                ...
                <NumberTicker value={5} className="text-secondary" />
                <span>+ Startups Launched</span>
              </div>
              <div className="flex items-center space-x-1">
                <Users className="h-4 w-4" />
                <NumberTicker value={20} className="text-secondary" />
                <span>+ Mentors</span>
              </div>
              <div className="flex items-center space-x-1">
                <Coins className="h-4 w-4" />
                <NumberTicker value={30} className="text-secondary" />
                <span>k+ Funding</span>
              </div>
            </div>
          </div>
